 ...
 */
final class Version20241206185056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP category_id, DROP panier_id, DROP description, DROP created_at, CHANGE prix prix DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD category_id INT DEFAULT NULL, ADD panier_id INT DEFAULT NULL, ADD description VARCHAR(255) NOT NULL, ADD created_at DATE NOT NULL, CHANGE prix prix INT NOT NULL');
